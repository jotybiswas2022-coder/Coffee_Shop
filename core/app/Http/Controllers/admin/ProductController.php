...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/product')->with('success', 'Item added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'base_price.lte' => 'Base price cannot be greater than item price.',
        ]);
        ...
        return redirect('/admin/product')->with('success', 'Item updated successfully!');
    }
    ...
    public function delete($id)
    {
        ...
        $product->delete();
        return redirect('/admin/product')->with('success', 'Item deleted successfully!');
    }
