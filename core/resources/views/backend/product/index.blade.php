...
<div class="container-fluid" style="height: calc(100vh - 80px); overflow-y: auto; padding-bottom: 20px;">
    ...
    <div class="row m-3 align-items-center mb-3">
        <div class="col-md-6">
            <h2 class="fw-bold mb-1">Item List <small class="text-muted">({{ $products->count() }})</small></h2>
            <small class="text-muted">Manage all your items efficiently</small>
        </div>
    ...
    <div class="card mx-3 shadow-sm border-0 rounded-3">
        <div class="card-body p-2">
            ...
            <div class="mb-3">
                <input type="text" id="productSearch" class="form-control" placeholder="Search items by name or category...">
            </div>
