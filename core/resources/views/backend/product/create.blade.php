    ...
    <div class="row px-3 pt-3 pb-2 align-items-center">
        <div class="col-md-8">
            <h3 class="fw-bold mb-1">
                <i class="bi bi-plus-circle me-2 text-primary"></i> Add New Item
            </h3>
            <small class="text-muted">Fill the form below to add a new Item</small>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">
                            ...
                            Item Base Price <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                            <span class="input-group-text bg-light">৳</span>
                            <input type="number" class="form-control"
                                   name="base_price"
                                   placeholder="Enter item base price"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">
                            ...
                            Item Sell Price <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                            <span class="input-group-text bg-light">৳</span>
                            <input type="number" class="form-control"
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">
                            ...
                            Item Stock <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                            <span class="input-group-text bg-light">
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">
                            ...
                            Item Image <span class="text-danger">*</span>
                        </label>
                        <input type="file"
                               accept="image/*"
                               class="form-control"
